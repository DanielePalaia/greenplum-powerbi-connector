...
// 
section Greenplum_ODBC_DirectConnect;
...
//
Config_DriverName = "DataDirect 7.1 Greenplum Wire Protocol";
...
[DataSource.Kind="Greenplum_ODBC_DirectConnect", Publish="Greenplum_ODBC_DirectConnect.Publish"]
shared Greenplum_ODBC_DirectConnect.Contents = (dsn as text) =>
    let
        //
...
Greenplum_ODBC_DirectConnect.Publish = [
    Beta = true,
    Category = "Other",
    ...
    SourceImage = Greenplum_ODBC_DirectConnect.Icons,
    SourceTypeImage = Greenplum_ODBC_DirectConnect.Icons
];

Greenplum_ODBC_DirectConnect.Icons = [
